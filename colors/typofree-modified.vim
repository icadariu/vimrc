" Vim color file
" Name:           typofree-modified.vim
" Description:    Modified version of typofree color scheme
...
let colors_name = "typofree-modified"
...
hi IncSearch     ctermfg=209   ctermbg=160    cterm=NONE
hi Search        ctermfg=209   ctermbg=160    cterm=NONE
hi Visual        ctermfg=231   ctermbg=60    cterm=NONE
hi Error         ctermfg=231   ctermbg=160    cterm=NONE

hi FoldColumn    ctermfg=160    ctermbg=NONE  cterm=NONE
...
hi SpecialChar   ctermfg=160    ctermbg=NONE  cterm=NONE " hex, ocatal etc.
